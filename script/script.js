    ...
    var cs = new Vue({
        ...
        methods:{
          makecode: function(){
              ...
              $("#chip").css("background-color","#"+this.redhex+this.greenhex+this.bluehex);
            },
            addchip: function(){
...
//    $(".chip").click(function(){
//        var copytxt = $(this).children(".card-footer").text();
//        $("#copyform").val(copytxt);
//        $("#copyform").select();
//        document.execCommand("copy");
//    });
    
//    $(".chip .card-footer").mouseover(function(){
